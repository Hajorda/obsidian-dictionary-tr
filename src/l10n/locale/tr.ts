...
export default {
    ...
    'Copy': 'Yapıştır',
    'Paste': 'Kopyala',
    'Show Synonyms': 'Eş anlamlıları göster',
    'Look up': 'Look up',
    ...
    'Language': 'Dil',
    'The Language the Plugin will use to search for Definitions and Pronunciations.': 'Eklentinin anlam ve telefuz ararken kullanacağı dil.',
    'Synonym Suggestions': 'Eşanlamlı önerileri',
    'Show synonyms for highlighted words': 'Vurgulanmış kelimeler için eşanlamlıları göster,
    ...
    'Click ': 'Tıkla ',
    'here': 'burası',
    ' for Privacy Concerns.': ' Gizlilik endişeleri yüzünden.',
    ...
    'Synonym Provider': 'Eş anlamlı sağlayıcı',
